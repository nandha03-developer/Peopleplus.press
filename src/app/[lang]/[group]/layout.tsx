...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  try {
    const groupResponse = await fetch(`https://s1jota6yr2.execute-api.ap-south-1.amazonaws.com/default/List_api_tables?table_name=Group&groupname_contains=${group}`);
