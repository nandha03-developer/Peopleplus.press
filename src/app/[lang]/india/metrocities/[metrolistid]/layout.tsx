...
export async function generateMetadata({ params }: any): Promise<Metadata> {
 // const { metrolistid } = params;
 const metrolistid = (await params).metrolistid
  const formattedMetro = formatStateId(metrolistid);
  try {
    ...
    const groups = states.find((state: any) => state.city == formattedMetro)
