...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  const webStoryId = (await params).shortsId
  try {
    const groupResponse = await fetch(`https://s1jota6yr2.execute-api.ap-south-1.amazonaws.com/default/List_api_tables?table_name=News&status_eq=true&youtubeshorts_contains=${webStoryId}&youtubeshorts_contains=https://www.youtube.com`);
